...
export default function EditService ({ icon, name, description }) {
                ...
                <div className="md:mx-20">
                    ...
                    <div className="hidden md:block" id="icon">
                        <IconPicker
                            ...
                            value={iconValue} onChange={(v) => setValue(v)} />
                    </div>

                    <div className="md:hidden" id="icon">
                        <IconPicker value={iconValue} onChange={(v) => setValue(v)} />
                    </div>
                </div>
                ...
                <form className="md:mx-20 mt-5" onKeyDown={handleKeyDown} onSubmit={handleForm}>
                    <div className="grid gap-6 md:grid-cols-1 mb-5">
                        ...
                        <div>
                            ...
                            <input defaultValue={newName} type="name" name="name" id="name" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="name@flowbite.com" required />
                        </div>
                    ...
                    <div>
                        ...
                        <textarea defaultValue={newDescription} type="text" name="subject" rows="10" id="subject" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="" required />
                    </div>
